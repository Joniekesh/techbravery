...
const Services = () => {
  return (
    <div className="services">
      ...
      <p>
        Whatever tech solutions you want, we are at your beck and call to take
        your business to the next level. We take calculated and guided approach
        to architect, develope, test, deploy and maintain your secure,
